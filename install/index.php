...
class mderrdx_infoblocks extends CModule
{
    public $MODULE_ID = 'mderrdx.infoblocks';
    ...
    public function __construct()
    {
        ...
        $this->MODULE_NAME = 'Работа с инфоблоками';
        $this->MODULE_DESCRIPTION = 'Работа с инфоблоками';
    }
